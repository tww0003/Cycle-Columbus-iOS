...
- (void)initInfoView
{
	...
	if ([note.image_data length] != 0 && textLength != 0) {
        ...
        if ([UIScreen mainScreen].scale == 2.f && [[UIScreen mainScreen] bounds].size.height == 568.0f)
        {
            ...
            noteImageResize = [[UIImageViewResizable alloc] initWithFrame:CGRectMake(0, 0, 320, 500)];
        }
        else
        {
            scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, 320, 413)];
            noteImageResize = [[UIImageViewResizable alloc] initWithFrame:CGRectMake(0, 0, 320, 413)];
        }
...
//        noteImage.contentMode = UIViewContentModeScaleAspectFill;
    ...
    if ([note.image_data length] != 0 && textLength == 0) {
        ...
        {
            scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, 320, 500)];
            noteImage   = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 320, 500)];
        }
        else
        {
            scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, 320, 413)];
            noteImage   = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 320, 413)];
        }
